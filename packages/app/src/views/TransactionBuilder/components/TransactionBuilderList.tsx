...
export const TransactionBuilderList = ({ transactions }: TransactionBuilderListProps) => {
  ...
  const handleDragUpdate = (update: DragUpdate) => {
    if (update.destination && update.destination.index !== update.source.index) {
    ...
    <div className={classes.root}>
      ...
      >
        <Droppable droppableId='transactions'>
          {(provider) => (
            <div ref={provider.innerRef} style={{ width: '100%' }} {...provider.droppableProps}>
