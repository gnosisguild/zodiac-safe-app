      ...
      <Grid container spacing={4} className={classes.container}>
        <Grid item>
          <Grid container spacing={2} className={classes.container}>
            ...
            <Grid item>
              <Typography>
                Configure your governor contract. It can always be changed later, so don&apos;t
          ...
          <Grid container spacing={1} className={classes.container}>
            ...
            <Grid item>
              <Typography variant='body2' className={classes.textSubdued}>
                Configure a delay modifier to determine the duration required before voting
                (Cooldown), and the amount of time that the proposal will be valid (Expiration).
              </Typography>
            </Grid>
          </Grid>
        </Grid>
