        ...
        <Grid container spacing={1} direction='column'>
          ...
          <Grid item>
            <Typography variant='body2' className={classes.textSubdued}>
              The oracle template creates an appropriate question based on the data of the proposal.
              We highly recommend using the default Zodiac Reality Module template
            </Typography>
          </Grid>
        </Grid>
      </Grid>
